...
class Controller:
    def setup(self, T_bat_target, T_env):
        ...
        residual_mlp.load_state_dict(torch.load("heating_pretrain_scaled_network_4_input_new_loss_filtered_tanh_jac_penalty_phys_penalty_FINAL_FINAL.pth", weights_only=True))
