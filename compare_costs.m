...
%% Get data
logged_data_traditional = load("Traj_Simulation_Data/nominal_cooling_plus_36_mismatched_fixed_nonlin.mat");
...
%% Get data
logged_data_nn = load("Traj_Simulation_Data/adaptive_cooling_plus_36_mismatched_fixed_nonlin.mat");
...
legend('Adaptive', 'Nominal', 'Target', 'Location','southeast')
xlabel("Time (s)")
ylabel('Temperature ($^\circ$C)', 'Interpreter', 'latex')
axis([1, N_reps*2475, 19.5, 24])
