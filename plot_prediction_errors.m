logged_data_nn = load("pred_error_nn_steady_state_extended.mat");
outputs_nn = logged_data_nn.data;
logged_data_no_nn = load("pred_error_nominal_steady_state_extended.mat");
outputs_no_nn = logged_data_no_nn.data;

pred_error_nn = abs(getElement(outputs_nn, "pred_error_nn").Values.Data(1:end));
pred_error_nominal = abs(getElement(outputs_no_nn, "pred_error_nn").Values.Data(1:end));
