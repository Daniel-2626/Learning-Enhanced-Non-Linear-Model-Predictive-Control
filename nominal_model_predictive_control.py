...
class Controller:
    def setup(self, T_bat_target):
        ...
        T_coolant_in =  T_bat + 1/(1-ca.exp(-NTU_bat)+1e-3)*Q_heat/(mdot_c * c_coolant + 1e-3)
        T_coolant_out = (T_coolant_in - T_bat) * ca.exp(-NTU_bat) + T_bat
        
        Q_cool = mdot_c * c_coolant * (T_coolant_out-T_coolant_in)
        ## Controller model 
        ...
        self.u0 = 1000*ca.DM.ones((n_controls, N))
        self.X0 = 1000*ca.DM.ones((n_states, N+1))
