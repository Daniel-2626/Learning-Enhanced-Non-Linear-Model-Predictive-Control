...
def nominal_dynamics_torch(state, u):
    # Match the nominal parameters from your CasADi model
    nominal_ratio = 1
    A1 = 1 #* nominal_ratio
    a1 = 0.1 * nominal_ratio
    A2 = 1 #* nominal_ratio
        ...
        for epoch in range(100):
            ...
            for k0 in range(0, batch_size, T_rollout):
                ...
                for step in range(T_rollout):
                    ...
                    h_pred = h_pred_next            # Normalize loss across all predictions made in this epoch
...
df.to_csv("cascaded_adaptive_matched.csv", index=False)
