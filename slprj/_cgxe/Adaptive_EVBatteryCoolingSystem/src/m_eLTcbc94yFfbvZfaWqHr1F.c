...
static void cgxe_mdl_start(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance);
static void CheckPythonError(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void b_assignToPyDict(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void c_assignToPyDict(PyObject *dict, char_T *key, PyObject *val);
static void d_assignToPyDict(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *b_getPyDictVal(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *c_getPyDictVal(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *dict, char_T *key);
static void e_assignToPyDict(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void f_assignToPyDict(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void g_assignToPyDict(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void h_assignToPyDict(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void i_assignToPyDict(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void j_assignToPyDict(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *d_getPyDictVal(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *e_getPyDictVal(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *f_getPyDictVal(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance, PyObject *dict, char_T *key);
...
static void c_execPyScript(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_eLTcbc94yFfbvZfaWqHr1F
  *moduleInstance);
  ...
  *moduleInstance)
{
  ...
  b_execPyScript(moduleInstance,
                 "omega, Q_heat, T_bat_pred = myController.get_input(20.5+273.15,T_bat_0, SOC_0, current, 0, 0)",
                 moduleInstance->namespaceDict);
...
/* CGXE Glue Code */
static void mdlOutputs_eLTcbc94yFfbvZfaWqHr1F(SimStruct *S, int_T tid)
{
  InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *moduleInstance =
    (InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_eLTcbc94yFfbvZfaWqHr1F(SimStruct *S)
{
  InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *moduleInstance =
    (InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_eLTcbc94yFfbvZfaWqHr1F(SimStruct *S, int_T tid)
{
  InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *moduleInstance =
    (InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_eLTcbc94yFfbvZfaWqHr1F(SimStruct *S)
{
  InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *moduleInstance =
    (InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_eLTcbc94yFfbvZfaWqHr1F(SimStruct *S)
{
  InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *moduleInstance =
    (InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_eLTcbc94yFfbvZfaWqHr1F(SimStruct *S)
{
  InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *moduleInstance =
    (InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_eLTcbc94yFfbvZfaWqHr1F(SimStruct *S)
{
  InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *moduleInstance =
    (InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_eLTcbc94yFfbvZfaWqHr1F(SimStruct *S)
{
  InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *moduleInstance =
    (InstanceStruct_eLTcbc94yFfbvZfaWqHr1F *)calloc(1, sizeof
    (InstanceStruct_eLTcbc94yFfbvZfaWqHr1F));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_eLTcbc94yFfbvZfaWqHr1F);
  ssSetmdlInitializeConditions(S, mdlInitialize_eLTcbc94yFfbvZfaWqHr1F);
  ssSetmdlUpdate(S, mdlUpdate_eLTcbc94yFfbvZfaWqHr1F);
  ssSetmdlDerivatives(S, mdlDerivatives_eLTcbc94yFfbvZfaWqHr1F);
  ssSetmdlTerminate(S, mdlTerminate_eLTcbc94yFfbvZfaWqHr1F);
  ssSetmdlEnable(S, mdlEnable_eLTcbc94yFfbvZfaWqHr1F);
  ssSetmdlDisable(S, mdlDisable_eLTcbc94yFfbvZfaWqHr1F);
...
static void mdlProcessParameters_eLTcbc94yFfbvZfaWqHr1F(SimStruct *S)
{
}

void method_dispatcher_eLTcbc94yFfbvZfaWqHr1F(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_eLTcbc94yFfbvZfaWqHr1F(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_eLTcbc94yFfbvZfaWqHr1F(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: eLTcbc94yFfbvZfaWqHr1F.\n"
...
mxArray *cgxe_eLTcbc94yFfbvZfaWqHr1F_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_eLTcbc94yFfbvZfaWqHr1F_fallback_info(void)
{
